      ...
      <div className="w-full pt-5 pb-4 px-10 bg-white">
        <div className="flex items-center gap-16">
          ...
          <div className="flex gap-5">
            <BiMenuAltRight className="text-black text-xl -rotate-90" />

            <AiOutlineMenu className="text-[#22B5DC] text-xl" />
          </div>
        </div>
        <div className=" mt-4 flex justify-between items-center">
          ...
          <div className="flex gap-7 items-center">
            <p className="text-sm font-normal text-[#838383]">
             {subArrays[From].from + 1} - {subArrays[From].to + subArrays[From].from} из {CompanyClients.length}
            </p>
            <div className="flex">
              <p onClick={()=>{
                if(From !== 0){
